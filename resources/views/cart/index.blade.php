                    ...
                    <div class="flex items-center gap-4 border-b pb-4">
                        ...
                        <div class="flex-1">
                            ...
                            <form action="{{ route('cart.update', $item['id']) }}"
                                ...
                                <button type="submit"
                                        class="px-3 py-1 bg-pink-500 text-white text-xs rounded hover:bg-pink-600">
                                    Update
                                </button>
                            </form>
                        </div>
            ...
            <div class="mt-6 flex items-center justify-between">
                ...
                <div class="flex gap-3">
                    <form action="{{ route('cart.clear') }}" method="POST">
                        @csrf
                        <button class="px-4 py-2 border border-pink-400 text-pink-600 rounded-lg hover:bg-pink-50">
                            Kosongkan
                        </button>
                    </form>
